...
/**
  ...
  * @n: pointer to the decimal number whose bits are to be manipulated.
  * @index: the position, starting from zero, where the bit is to be adjusted
  * to 1.
  * Return: the decimal number that results after the bit is adjusted to 1.
  */
